...
import { fetchCommentReport, fetchPostReport, fetchUserReport } from "@actions/reportActions";
...
import UserCard from "@components/UI/Profile/UserCard";
import UserProps from "@components/UI/Props/UserProps";
...
export default function Users() {
  ...
  const fetchComments = async () => {
    setIsLoading(true);
    const res = await fetchUserReport(
      page,
      LIMIT,
      searchText,
      resolvedFilter,
              ...
              <MasonryLayout
                ...
                holder={(item) => (
                  <div
                    ...
                    onClick={() =>
                      router.push(`/admin/reports/users/${item._id}`)
                    }
                  >
                    <UserProps user={item.reportTarget}  />
