      ...
      >
        {themes.map((theme) => (
          <div
            ...
            onClick={async () =>
              changeChatTheme(chatInfo.chatId, theme, session?.user.id || "")
            }
          >
            ...
            <div
              className={` bg-secondary-1/50 w-full grow flex flex-col-reverse p-1 gap-1`}
              style={{
            ...
            <div
              className="h-7 w-full bg-secondary-1 flex flex-row justify-between items-center p-1 gap-1"
            >
